...
public class Token {
	 ...
	 * values.
	 *
	 * @param TokenType the type of the token, typically one of the constants this
	 *                  class defines
	 *
	 * @param string    the string value of the token, typically null except for
	 *                  WORD and QUOTED tokens
	 *
	...
	/**
	 * Returns true if the supplied object is an equivalent token, given mellowness
	 * about case in strings and characters.
	 *
	 * @param object the object to compare
	 *
