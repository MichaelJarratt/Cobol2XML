...
public class TokenAssembly extends Assembly {
	...
	/**
	 * Returns a textual representation of the amount of this tokenAssembly that has
	 * been consumed.
	 *
	 * @param delimiter the mark to show between consumed elements
	 *
	 * @return a textual description of the amount of this assembly that has been
	 *         consumed
	 */
	 ...
	 *
	 * @exception ArrayIndexOutOfBoundsException if there are no more tokens in this
	 *                                           tokenizer's string.
	 */
	 ...
	 * @param delimiter the mark to show between consumed elements
	 *
	 * @return a textual description of the amount of this assembly that remains to
	 *         be consumed
	 */
