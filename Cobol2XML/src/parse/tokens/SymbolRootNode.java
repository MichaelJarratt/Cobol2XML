...
public class SymbolRootNode extends SymbolNode {
	...
	/*
	 * Set all possible symbols to be valid children. This means that the decision
	 * of which characters are valid one- character symbols lies outside this tree.
	 * If a tokenizer asks this tree to produce a symbol, this tree assumes that the
	 * first available character is a valid symbol.
	 */
	protected void init() {
	 ...
	 *
	 * @param int            the first character of this symbol, already read from
	 *                       the reader
	 *
	 * @return a symbol string from a reader
	 */
