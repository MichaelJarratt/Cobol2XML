...
public class WordState extends TokenizerState {
	 ...
	 * word after the first character. Note that the tokenizer must determine which
	 ...
	 * @param to      char
	 *
	 * @param boolean true, if this state should allow characters in the given range
	 *                as part of a word
	 */
