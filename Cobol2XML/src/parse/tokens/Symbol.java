...
public class Symbol extends Terminal {
	 ...
	 *
	 * @param char the character to match. The char must be one that the tokenizer
	 *             will return as a symbol token. This typically includes most
	 ...
	 *
	 * @param String the characters to match. The characters must be a sequence that
	 *               the tokenizer will return as a symbol token, such as
	 *               <code><=</code>.
	 *
