...
public class TokenStringSource {
	 ...
	 *
	 * @param delimiter the character that fences off where one TokenString ends and
	 *                  the next begins
	 *
	 * @returns a TokenStringSource that will read TokenStrings from the specified
	 *          tokenizer, delimited by the specified delimiter
	 */
	...
	/**
	 * The design of <code>nextTokenString</code> is that is always returns a cached
	 * value. This method will (at least attempt to) load the cache if the cache is
	 * empty.
	 */
	...
	/**
	 * Loads the next TokenString into the cache, or sets the cache to null if the
	 * source is out of tokens.
	 */
	...
	/**
	 * Returns a Vector of the tokens in the source up to either the delimiter or
	 * the end of the source.
	 *
	 * @return a Vector of the tokens in the source up to either the delimiter or
	 *         the end of the source.
	 */
