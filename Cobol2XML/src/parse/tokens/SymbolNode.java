...
public class SymbolNode {
	...
	/*
	 * Mark this node as valid, which means its ancestry is a complete symbol, not
	 * just a prefix.
	 */
	 ...
	 * complete symbol. If this node is not valid, put back the character and ask
	 * the parent to unwind.
	 */
