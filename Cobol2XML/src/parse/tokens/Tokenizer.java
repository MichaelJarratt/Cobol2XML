...
public class Tokenizer {
	...
	public Token nextToken() throws IOException {
		...
		/*
		 * There was a defect here, that resulted from the fact that unreading a -1
		 * results in the next read having a value of (int)(char)-1, which is 65535.
		 * This may be a defect in PushbackReader.
		 */
	...
	/**
	 * Change the state the tokenizer will enter upon reading any character between
	 * "from" and "to".
	 *
	 ...
	 *
	 * @param TokenizerState the state to enter upon reading a character between
	 *                       "from" and "to"
	 */
