...
public class Sequence extends CollectionParser {
	...
	/**
	 * Given a set of assemblies, this method matches this sequence against all of
	 ...
	 * This is an empty string, since convention indicates sequence quietly. For
	 * example, note that in the regular expression <code>(a|b)c</code>, the lack of
	 * a delimiter between the expression in parentheses and the 'c' indicates a
