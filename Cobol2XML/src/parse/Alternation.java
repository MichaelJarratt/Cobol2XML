...
public class Alternation extends CollectionParser {
	...
	/**
	 * Given a set of assemblies, this method matches this alternation against all
	...
	public Vector<Assembly> match(Vector<Assembly> in) {
		...
		Enumeration<Parser> e = subparsers.elements(); // collection of Sequence - checks if cobol line (assembly in) is
														// matched by any of the sequences
	...
	/*
	 * This method is similar to randomExpansion, but it will pick a terminal if one
	 * is available.
	 */
	...
	/*
	 * Returns the string to show between the parsers this parser is an alternation
	 * of.
	 */
