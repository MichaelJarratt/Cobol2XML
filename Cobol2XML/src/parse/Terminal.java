...
public class Terminal extends Parser {
	...
	/**
	 * Given a collection of assemblies, this method matches this terminal against
	 * all of them, and returns a new collection of the assemblies that result from
	 * the matches.
	 *
	 ...
	 * terminal will have been removed from the front of the assembly. As with any
	 * parser, if the match succeeds, this terminal's assembler will work on the
	 * assembly. If the match fails, this method returns null.
	 *
	 ...
	 * check that the next element on the assembly qualifies as the type of terminal
	 * this terminal looks for. This method performs that check.
	 *
	 ...
	 * successful match. This routine will turn off (or turn back on) that behavior.
	 * 
	 * @param boolean true, if this terminal should push itself on a assembly's
	 *                stack
	 *
	 * @return this
	 */
