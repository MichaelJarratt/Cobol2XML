...
public class LimitingLinearCalculator extends LinearCalculator {
	...
	/**
	 * Return the value on the first scale, corresponding to the given value on the
	 * second scale. Limit the X value to be between xFrom and xTo.
	 *
	 * @return the value on the first scale, corresponding to the given value on the
	 *         second scale
	 */
	...
	/**
	 * Return the value on the second scale, corresponding to the given value on the
	 * first scale. Limit the Y value to be between yFrom and yTo.
	 *
